...
import { calcThirdAngle } from "../src/triangle.js";
...
describe("calcThirdAngle", () => {
  ...
  it("should throw an error for invalid angles", () => {
    expect(() => calcThirdAngle(-10, 20)).toThrow();
    expect(() => calcThirdAngle(30, 150)).toThrow();
    expect(() => calcThirdAngle(0, 30)).toThrow();
  });
});
